...
//~ 头部导航菜单
class utage_Bootstrap_Menu extends Walker {
	...
	function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		if( $depth > 0 && $item->description ) $item_output .= '<li style="color:red;" role="presentation" class="dropdown-header">'.$item->description.'</li><li class="divider"></li>';
		...
		$is_parent = 0;
		if ( ($args->depth)>=0 && in_array( 'menu-item-has-children', $item->classes ) ){
			if($depth == 0 ){
